...
LCD.prototype._sleep = function (ms) {
	var start = Date.now(); //  milliseconds
	while (Date.now() < start + ms) {}
}

LCD.prototype._noop = function() {}

LCD.prototype.write4 = function (x, c) {
	var a = (x & 0xF0); // Use upper 4 bit nibble
	this.i2c.writeByte(a | displayPorts.backlight | c, this._noop);
	this.i2c.writeByte(a | displayPorts.E | displayPorts.backlight | c, this._noop);
	this.i2c.writeByte(a | displayPorts.backlight | c, this._noop);
	this._sleep(1);
}
